  ...
  return (
    <div className={`flex-1 flex flex-col h-full bg-[var(--surface-panel)] overflow-hidden relative ${wrapLines ? 'diff-wrap-lines' : ''}`}>
      ...
      {selectedHunkIds.size > 0 && (
        <div className="diff-selection-bar absolute bottom-3 left-6 right-6 bg-[var(--surface-canvas)]/95 border border-[var(--border-subtle)] rounded-xl px-4 py-2.5 shadow-xl flex items-center justify-between z-30 animate-in slide-in-from-bottom-2 duration-150">
