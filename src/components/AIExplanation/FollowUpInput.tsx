  ...
  return (
    ...
    >
      <input
        ...
        className="flex-1 bg-[var(--surface-panel)] text-xs text-zinc-900 px-3 py-2 rounded-md border border-[var(--border-subtle)] focus:outline-none focus:border-[var(--accent)] transition placeholder:text-zinc-600 disabled:opacity-50 font-sans"
      />
