...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 flex items-center justify-center p-4">
      <div className="bg-[#191C21] border border-white/10 rounded-xl w-full max-w-2xl shadow-2xl overflow-hidden text-slate-200 flex flex-col max-h-[90vh]">
        {/* Header */}
        <div className="px-5 py-4 bg-[#121417] border-b border-white/10 flex items-center justify-between shrink-0">
        ...
        {/* Tab Switcher */}
        <div className="flex items-center bg-[#15171A] px-5 pt-2 border-b border-white/5 space-x-4 text-xs font-semibold select-none shrink-0">
          <button
            type="button"
        ...
        <form onSubmit={handleSave} className="p-5 space-y-4 text-xs overflow-y-auto flex-1">
            ...
            <div className="space-y-4">
                    ...
                    <button
                      ...
                      className={`p-2.5 rounded-lg border text-left transition flex flex-col justify-between ${
                        form.provider === item.id
                          ...
                          : 'bg-[#1F2227] border-white/5 text-slate-400 hover:text-slate-200 hover:border-white/10'
                      }`}
                    >
              ...
              <div className="space-y-3 pt-2 border-t border-white/5">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#15171A] border border-white/10 rounded-lg px-3 py-2 text-slate-200 focus:outline-none focus:border-blue-500/50"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#15171A] border border-white/10 rounded-lg px-3 py-2 text-slate-200 font-mono text-[11px] focus:outline-none focus:border-blue-500/50"
                  />
                </div>
                ...
                <div>
                  <div className="flex items-center justify-between mb-1">
                    ...
                    {form.provider === 'openrouter' && (
                      <span className="text-[10px] text-blue-300">💡 点击下方推荐模型快捷填入</span>
                    )}
                  </div>
                  <input
                    type="text"
              ...
              <div className="pt-3 border-t border-white/5 space-y-3">
                ...
                <input
                  ...
                  className="w-full bg-[#15171A] border border-white/10 rounded-lg px-2.5 py-1.5 text-slate-200 font-mono text-xs focus:outline-none focus:border-amber-500/50"
                />
          ...
          {activeTab === 'prompts' && (
            <div className="space-y-4">
              ...
              <div className="flex items-start justify-between gap-2">
                <div className="flex flex-wrap items-center bg-[#15171A] border border-white/10 rounded-lg p-1 gap-1">
                  <button
                    type="button"
                ...
                <button
                  ...
                  className="text-[11px] text-blue-400 hover:text-blue-300 flex items-center gap-1 shrink-0 ml-2"
                ...
                <div className="space-y-3 animate-in fade-in duration-150">
                  ...
                  <div className="space-y-1.5 pt-1">
                    ...
                    <textarea
                      ...
                      className="w-full bg-[#15171A] border border-white/10 rounded-lg p-3 text-slate-200 text-xs focus:outline-none focus:border-blue-500/50 leading-relaxed font-sans"
                    />
              ...
              {promptCategory === 'learn' && (
                <div className="space-y-3 animate-in fade-in duration-150">
                  <div className="p-3 bg-[#15181C] border border-white/5 rounded-lg text-slate-300 text-xs">
                    <span className="font-semibold text-blue-300">💡 功能说明：</span>
          ...
          {activeTab === 'agent' && (
            <div className="space-y-4">
              <div className="p-3 bg-blue-950/25 border border-blue-500/30 rounded-lg text-slate-300 text-xs flex items-center justify-between">
              ...
              <div className="p-3 bg-[#15171A] border border-white/5 rounded-lg space-y-3">
                <div className="flex items-center justify-between">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button
                    ...
                    className={`p-2.5 rounded-lg border text-left transition ${
                      !form.maxExplorationTurns || form.maxExplorationTurns === 0
                        ? 'bg-blue-600/20 border-blue-500 text-white shadow-sm'
                        : 'bg-[#191C21] border-white/5 text-slate-400 hover:text-slate-200'
                    }`}
                  >
                    <div className="flex items-center justify-between font-semibold text-xs">
                      <span>🤖 自动规划 (推荐)</span>
                ...
                {form.maxExplorationTurns && form.maxExplorationTurns > 0 ? (
                  <div className="space-y-1.5 pt-2 border-t border-white/5">
                    ...
                    <input
                      ...
                      className="w-full bg-[#191C21] border border-white/10 rounded-lg px-2.5 py-1.5 text-slate-200 font-mono text-xs focus:outline-none focus:border-blue-500/50"
                    />
                  </div>
                ) : null}
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {/* Timeout */}
                <div className="p-3 bg-[#15171A] border border-white/5 rounded-lg space-y-1.5">
              ...
              <div className="p-3 bg-[#15171A] border border-white/5 rounded-lg space-y-2">
                <div className="flex items-center justify-between">
          ...
          <div className="pt-3 border-t border-white/10 flex items-center justify-between shrink-0">
            ...
            <div className="flex items-center space-x-2">
              ...
              <button
                type="submit"
                className="px-4 py-1.5 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-semibold transition flex items-center space-x-1 shadow-md"
              >
